...
--////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 ...
 function GM_FestticalLogin_instance_SetData(_nCfgId,_nBeginTime,_nEndTime,_nOSTime)
	if "table" == type(festivallogin_Info) then
			...
			if _nCfgId == v.id then
				...
				if _nOSTime >= _nBeginTime and _nOSTime < _nEndTime then			
					if 0 == System_GetGlobalData(nLuaGlobal,1) then
						...
						System_CallLuaOnline(("</F>FestivalLogin_Person_Login</N>CHARACTER_ID</N>".._nOSTime))
					end					
				else					
...
function GM_FestticalLogin_instance_SetEndData(_nEndTime,_nOSTime)
 ...
 function GM_FestticalLogin_instance_GetData(_nCfgId,_nOSTime,_nType)
	-- 活动结束时间戳
...
--	有任意玩家登录时处理
-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
function GM_FestticalLogin_instance_Login(_nOSTime)
	if false == System_IsExistGlobalData(nLuaGlobal) then
...
--	0点刷新 更新数据
-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
function GM_FestticalLogin_instance_ZeroFresh(_nOSTime)	
...
table.insert(tTime_HM[nDayBeginTime],GM_FestticalLogin_instance_ZeroFresh)